...
<body>
    ...
    <div id="carouselExampleCaptions" class="carousel slide carousel-fade" data-ride="carousel">
     ...
     if (isset($_GET['pageno'])) {
        ...
        $query=mysqli_query($con,"select ebookpost.id as pid,ebookpost.PostTitle as posttitle,ebookpost.PostDetails as postdetails, ebookpost.PostingDate as postdate, ebookcategory.CategoryName as category,ebookcategory.id as catid from ebookpost left join ebookcategory on ebookcategory.id=ebookpost.CategoryId where ebookpost.Is_Active=1 order by ebookpost.id desc  LIMIT $offset, $no_of_records_per_page ");
