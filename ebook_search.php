        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                ...
                <div class="carousel-caption d-none d-md-block ">
                    <h2 style="color: white; font-weight: 900;">Welcome to UEM Academia</h2>
...
$query=mysqli_query($con,"select ebookpost.id as pid,ebookpost.PostTitle as posttitle, ebookpost.PostDetails as postdetails, ebookpost.PostingDate as postdate, ebookcategory.CategoryName as category,ebookcategory.id as catid from ebookpost left join ebookcategory on ebookcategory.id=ebookpost.CategoryId where ebookpost.PostTitle like '%$st%' and ebookpost.Is_Active=1 LIMIT $offset, $no_of_records_per_page");
