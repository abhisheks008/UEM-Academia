...
<body>
    ...
    <div id="carouselExampleCaptions" class="carousel slide carousel-fade" data-ride="carousel">
        ...
        $total_pages = ceil($total_rows / $no_of_records_per_page);
                ...
                $query=mysqli_query($con,"select programpost.id as pid,programpost.PostTitle as posttitle, programpost.PostingDate as postdate, programcategory.CategoryName as category,programcategory.id as catid from programpost left join programcategory on programcategory.id=programpost.CategoryId where programpost.CategoryId='".$_SESSION['catid']."' and programpost.Is_Active=1 order by programpost.id desc LIMIT $offset, $no_of_records_per_page");
