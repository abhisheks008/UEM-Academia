...
<body>
    ...
    <div id="carouselExampleCaptions" class="carousel slide carousel-fade" data-ride="carousel">
        ...
        $total_pages = ceil($total_rows / $no_of_records_per_page);
                ...
                $query=mysqli_query($con,"select coursepost.id as pid,coursepost.PostTitle as posttitle, coursepost.PostingDate as postdate, coursecategory.CategoryName as category,coursecategory.id as catid from coursepost left join coursecategory on coursecategory.id=coursepost.CategoryId where coursepost.CategoryId='".$_SESSION['catid']."' and coursepost.Is_Active=1 order by coursepost.id desc LIMIT $offset, $no_of_records_per_page");
