...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class=" navbar-nav  ">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="Ebook.php">E-Books Library</a>
                    </li>
                    </li>
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                ...
                <div class="carousel-caption d-none d-md-block ">
                    <h2 style="color: yellow; font-weight: 900;">Welcome to UEM Academia</h2>
                    <p style="font-size: 25px;">Online Study Materials</p>
    ...
    <div class="container">
     ...
     if (isset($_GET['pageno'])) {
        ...
        $total_pages_sql = "SELECT COUNT(*) FROM coursepost";
        $result = mysqli_query($con,$total_pages_sql);
        $total_rows = mysqli_fetch_array($result)[0];
        $total_pages = ceil($total_rows / $no_of_records_per_page);

        
        $query=mysqli_query($con,"select coursepost.id as pid,coursepost.PostTitle as posttitle, coursepost.PostingDate as postdate, coursecategory.CategoryName as category,coursecategory.id as catid from coursepost left join coursecategory on coursecategory.id=coursepost.CategoryId where coursepost.Is_Active=1 order by coursepost.id desc  LIMIT $offset, $no_of_records_per_page ");
        ...
        ?>
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        ...
                        <p><b>Category : </b> <a
                                href="course_category.php?catid=<?php echo htmlentities($row['catid'])?>"><?php echo htmlentities($row['category']);?></a>
                        </p>

                        <a href="course_details.php?nid=<?php echo htmlentities($row['pid'])?>"
