    ...
    <div id="carouselExampleCaptions" class="carousel slide carousel-fade" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                ...
                <div class="carousel-caption d-none d-md-block ">
                    ...
                    <h3 style="font-size: 50px; font-family: Merriweabuther; "><i> Online Study Materials!</i>
                    </h3>
        ...
        <div class=" d-flex justify-content-center align-items-center p-md-3">
            ...
            <div class="content text-center">
                <h2 style="color: black; font-weight: 900; font-family: Merriweabuther;">- - - Lecture Description - - -</h2>
...
?>
              ...
              echo  (substr($pt,0));?></p>
                            ...
                            <a href=" <?php echo htmlentities($row['courselink']);?>" target="black"
                                class="btn btn-outline-success " role="button" aria-pressed="true">Watch Now!</a>
